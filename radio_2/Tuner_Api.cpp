...
const Radio_AreaConfigDef Radio_AreaConfig={
    ...
    15800,        1000,      5620,       522,         FM_Step_100k,        FM_Step_100k,                 9,                  9};
  //10800,        6500,      1620,       522,         FM_Step_100k,        FM_Step_100k,                 9,                  9}; //yang asli
  
const FreqBaundDef FreqBaundConfig[MaxBandNum]={		
   /*0-FM1,1-FM2,2-FM3,3-LW,4-MW,5-SW*/
    {6500,15800},{6500,10800},{6500,10800},{522,5710},{144,288},{2300,97000}};    
    
#elif (AreaSelect==Radio_EUR)  /*Europe */   	                        
const Radio_AreaConfigDef Radio_AreaConfig={
//FM_MaxFreq  FM_MinFreq  AM_MaxFreq  AM_MinFreq  FM_AutoSeekStep/k  FM_ManualSeekStep/k  AM_AutoSeekStep/k  AM_ManualSeekStep/k
10800,        6500,      2700,       144,         FM_Step_100k,        FM_Step_100k,               9,                  9}; //belum diedit
//14500,        5500,      2700,       144,         FM_Step_100k,        FM_Step_100k,               1,                  1};
...
const FreqBaundDef FreqBaundConfig[MaxBandNum]={		 //0-FM1,1-FM2,2-FM3,3-LW,4-MW,5-SW
  //  {6500,10800},{6500,10800},{6500,10800},{144,288},{522,1710},{2300,27000}};    // 
    {6500,10800},{6500,10800},{6500,10800},{144,288},{522,1710},{2300,2700}};    // 
...
const FreqBaundDef FreqBaundConfig[MaxBandNum]={		 //0-FM1,1-FM2,2-FM3,3-LW,4-MW,5-SW
    //{6500,10800},{6500,10800},{6500,10800},{144,288},{522,1710},{2300,27000}};    // 
    {6500,14800},{6500,14800},{6500,14800},{144,288},{522,5710},{2300,77000}};    // 
...
//AF_UPDATE not change current info
	...
	if(Is_Radio_Atomic2||Is_Radio_Lithio)
	{
        ...
        devTEF668x_Radio_Tune_To(Radio_IsFMBand(), (uint16_t)A2Mode, Freq);
	}
}
/*====================================================
...
uint16_t Radio_Get_Level(uint8_t fm)
{
    ...
    if(1 == devTEF668x_Radio_Get_Quality_Level(Radio_IsFMBand(),&status,&level))
    {
			return level;
		}
	}
